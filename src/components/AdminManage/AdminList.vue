<template>
    <div class="flex  items-center p-3">
        <div class="flex-auto w-full md:w-auto h-14">
            <h1 class="font-bold text-xl">Admin List</h1>
        </div>
        <div class="">
            <router-link to="/admin/registor">
                <button class="px-4 py-2 font-semibold rounded-lg shadow-md w-full md:w-56 btn-regis">
                    Registration
                </button>
            </router-link>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead>
                    <tr>
                        ...
                        <th class="text-center px-4 py-2">Land Company area</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <tr>
                        ...
                        <td class="px-4 py-2 text-center">111101111</td>
                        <td class="px-4 py-2 text-center">Sinxai</td>
